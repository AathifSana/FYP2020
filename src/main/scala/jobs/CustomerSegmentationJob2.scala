...
object CustomerSegmentationJob2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val minMaxPerCustomer = perCustomer.agg(
      ...
      stddev_pop(PURCHASES_PER_CUSTOMER), skewness(PURCHASES_PER_CUSTOMER),
      ...
      stddev_pop(AVG_PRICE_PER_PURCHASE_PER_CUSTOMER), skewness(AVG_PRICE_PER_PURCHASE_PER_CUSTOMER),
      ...
      stddev_pop(AVG_PRODUCTS_PER_PURCHASE_PER_CUSTOMER), skewness(AVG_PRODUCTS_PER_PURCHASE_PER_CUSTOMER),
      ...
      stddev_pop(AVG_QUANTITY_PER_PURCHASE_PER_CUSTOMER), skewness(AVG_QUANTITY_PER_PURCHASE_PER_CUSTOMER)

    )

    DataSource.saveDataFrameAsTSV(
      minMaxPerCustomer.repartition(1),
      writePath+"/minMaxPerCustomer",
...
//      AVG_PRODUCTS_PER_PURCHASE_PER_CUSTOMER, AVG_QUANTITY_PER_PURCHASE_PER_CUSTOMER, SIMILARITY, SEGMENT)
    ...
    DataSource.saveDataFrameAsTSV(
      ...
      writePath+"/customer_segments2",
      header = STR_BOOL_TRUE
    )

    DataSource.saveDataFrameAsTSV(
      segmentStats.repartition(1),
      writePath+"/segment_statistics2",
      header = STR_BOOL_TRUE
    )
